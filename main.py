...
BOT_TOKEN = "8339696536:AAF53lUwGnKv7rLDGvVRWeP5fj9ExnY6hdw"
API_KEY = "nxa_cf75b4a32cdf3165ab0aa6a133cb69ea3e450a97"  # জেনেক্স এপিআই কী
BASE_URL = "http://nexaotpservice.com/api/v1/"      # জেনেক্স এপিআই ডোমেন
...
WELCOME_MESSAGE = "✨ **WELCOME TO KSY NUMBER BOT** ✨\n━━━━━━━━━━━━━━━━━━━━━━\n🚀 **START INSTANT OTP RECEPTION NOW!** 🚀"
...
def load_settings():
    if not os.path.exists(SETTINGS_FILE):
        default = {
            ...
            "otp_group_url": "https://t.me/ksyotpgroup",
            "channel_url": "https://t.me/ksbd_yeasin",
            "support_username": "@ksysupport",
            ...
            "force_join_channels": ["https://t.me/ksbd_yeasin"], # ফোর্স জয়েন চ্যানেলসমূহ
    ...
    try:
        ...
        return {
            ...
            "force_join_channels": ["https://t.me/ksbd_yeasin"],
...
OTP_GROUP_ID = -1003760289145 = asyncio.Queue() 
MAX_WORKERS = 50000 
...
async def support_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    settings = load_settings()
    support_user = settings.get("support_username", "@ksysupport")
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/NETBOLDNETMAIR0", style="primary")]
    ])
...
async def process_auto_number(update, context, range_text):
    ...
    if is_user_banned(uid):
        settings = load_settings()
        support = settings.get("support_username", "@ksysupport")
    ...
    try:
        ...
        settings = load_settings()
        otp_group_url = settings.get("otp_group_url", "https://t.me/ksyotpgroup")
    ...
    while True:
        try:
            ...
            if top_ranges:
                ...
                if has_traffic:
                    lines.append("\n━━━━━━━━━━━━━━━━━━━━━━\n🚀 <i>KSY Number bot | Lightning Fast Delivery</i>")
                    broadcast_text = "\n".join(lines)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("mode") == "input_user_id" and is_admin(uid):
        ...
        status_msg = (
            ...
            f"━━━━━━━━━━━━━━━━━━━━━━\n"
            f"🚀 <b>KSY Number bot | LIVE REAL-TIME DATA</b> ⚡"
        )
